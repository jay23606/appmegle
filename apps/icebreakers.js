...
(function () {
    ...
    const GEMS = ["What's the bravest thing you've ever done?","What were you like as a kid?","What's a place that exceeded your expectations?","If you could give your younger self one piece of advice, what would it be?","What's something simple you're really grateful for?","What's your idea of a perfect day, start to finish?","What's a movie everyone loves that you just don't get?","What's the most useful thing you learned in the last year?","What's a random act of kindness you'll never forget?","What's something that instantly puts you in a good mood?","What's the best decision you've ever made?","What's a place you could happily get lost in?","Who's someone you admire, and why?","What's the funniest thing that's happened to you lately?","What's a skill you think everyone should learn?","What's your comfort rewatch for a bad day?","What's the nicest compliment you've ever received?","What's a tradition you'd love to start?","What's something you believe that not many people agree with?","What's the most fun you've had on a budget?","What's a tiny ritual that makes your day better?","What's the best gift you've ever given someone?","What's a subject you'd happily go back to school for?","What's something you've gotten much better at over the years?","What's a meal that tastes like home to you?","What's a song that always makes you want to dance?","What's something you were really into as a teenager?","What's a place you'd go back to in a heartbeat?","What's the best advice you've ignored?","What's something small you splurge on without guilt?","What's the most beautiful place you've ever woken up?","What's a story your family always tells about you?","What's something you find weirdly satisfying?","What's a fear you'd like to face this year?","What's a hobby that surprised you with how much you enjoyed it?","What's a moment you wish you could relive?","What's the best thing you've read or watched lately?","What's something that always makes you laugh no matter what?","What's a place that's been on your list forever?","What's the most you've ever surprised yourself?","What's a smell that instantly takes you back?","What's something you're secretly competitive about?","What's the best decision you almost didn't make?","What's a question you wish people asked you more often?","What's a small thing you do that you're oddly proud of?","What's something you could give a 20-minute talk on with no prep?","What's a compliment that has stuck with you?","What's a rule you live by?","What's something that's totally worth the money to you?"];
    const DESC = ['yourself','your perfect weekend','your dream home','your ideal job','your hometown','your sense of humor','your taste in music','your morning routine','your dream vacation','your perfect meal'];
    const MEM = ['meal','trip','gift','concert','conversation','compliment','adventure','birthday','road trip','act of kindness'];
    const ABSURD = ['a kitchen appliance','an animal','a season','a type of weather','a dessert','a city','a board game','a musical instrument','a fictional character','a sandwich'];
    ...
    const TEMPLATES = [
        ...
        () => 'How would you describe ' + pick(DESC) + ' in three words?',
        () => "What's a " + pick(MEM) + " you'll never forget?",
        () => 'If you were ' + pick(ABSURD) + ', which one would you be and why?',
        () => pick(GEMS), () => pick(GEMS), () => pick(GEMS)        // weight the hand-written gems
    ];
