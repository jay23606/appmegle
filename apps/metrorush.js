...
(function () {
    ...
    let particles = [], nearText = '', nearTimer = 0, shake = 0, skin = Number(localStorage.getItem('mr-skin') || 0) % SKINS.length;
    ...
    const begin = (sd, n, tally) => {
        ...
        hit = new Set(); collected = new Set(); passed = new Set(); particles = []; nearText = ''; nearTimer = shake = 0; winner = null; opp = { d: 0, l: 1, j: 0, boost: 0, crash: 0, skin: 0 };
