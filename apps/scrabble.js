...
//
// NOTE: there is no built-in dictionary (a full word list is ~2MB). Placement, premiums,
// cross-words, blanks and bingo bonus are all scored, but word *legality* is on the honour
// system — challenge each other over the video call, the way you would at a real table.
(function () {
